...
], CreateVisitorDto.prototype, "name", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateVisitorDto.prototype, "flatId", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateVisitorDto.prototype, "phone", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateVisitorDto.prototype, "vehicleNo", void 0);
let VisitorsController = class VisitorsController {
    ...
    async list(user) {
        ...
        return {
            visitors,
            summary: {
                insideNow: visitors.filter((v) => v.status === client_1.VisitorStatus.INSIDE)
                    .length,
    ...
    checkout(id) {
        return this.prisma.visitor.update({
            where: { id },
            data: { status: client_1.VisitorStatus.EXITED, outAt: new Date() },
        });
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, CreateVisitorDto]),
...
exports.VisitorsModule = VisitorsModule = __decorate([
    (0, common_1.Module)({ controllers: [VisitorsController] })
], VisitorsModule);
